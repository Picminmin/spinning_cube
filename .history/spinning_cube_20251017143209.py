...
colors = {
    ...
    "front": "\033[31m@\033[0m", # 紫(橙の代替)
    "front": "\033[31m@\033[0m", # 青
    "front": "\033[32m~\033[0m", # 緑
    "front": "\033[37m#\033[0m", # 白
    "front": "\033[33m;\033[0m", # 黄
}
# ============================
# 回転計算の高速版
# ============================
        ...
        for cube_width, horizontal_offset in zip(cube_widths, offsets):
            ...
            while cube_x < cube_width:
                ...
                while cube_y < cube_width:
                    ...
                    calculate_for_surface(cube_width + horizontal_offset, cube_y, cube_x, '$')   # 背面
                    calculate_for_surface(-cube_width + horizontal_offset, cube_y, -cube_x, '~') # 右面
